...
<TrainerSidebar />
        ...
        <div className="card-body p-0">
          <div id="wrap">
            <div id="calendar" className="position-relative">
              <button type="button" className="add-event btn btn-main text-sm btn-sm px-24 rounded-pill py-12 d-flex align-items-center gap-2" data-bs-toggle="modal" data-bs-target="#exampleModal">
            ...
            <div className="row">   
              ...
              <div className="col-md-6 mb-20">
                ...
                <div className=" position-relative">
                  <input className="form-control radius-8 bg-base" id="startDate" type="date" />
              ...
              <div className="col-md-6 mb-20">
                ...
                <div className=" position-relative">
                  <input className="form-control radius-8 bg-base" id="endDate" type="date" />
                  <span className="position-absolute end-0 top-50 translate-middle-y me-12 line-height-1" />
                </div>
              </div>
              <div className="col-12 mb-20">
                ...
                <div className="d-flex align-items-center flex-wrap gap-28">
                  <div className="form-check form-radio d-flex align-items-center gap-2 mb-0">
                    ...
                    <label className="form-check-label min-width-max-content line-height-1 fw-medium text-secondary-light text-sm d-flex align-items-center gap-1 ps-4" htmlFor="Personal"> 
                  ...
                  <div className="form-check form-radio d-flex align-items-center gap-2 mb-0">
                    ...
                    <label className="form-check-label min-width-max-content line-height-1 fw-medium text-secondary-light text-sm d-flex align-items-center gap-1 ps-4" htmlFor="Business"> 
                  ...
                  <div className="form-check form-radio d-flex align-items-center gap-2 mb-0">
                    ...
                    <label className="form-check-label min-width-max-content line-height-1 fw-medium text-secondary-light text-sm d-flex align-items-center gap-1 ps-4" htmlFor="Family"> 
                  ...
                  <div className="form-check form-radio d-flex align-items-center gap-2 mb-0">
                    ...
                    <label className="form-check-label min-width-max-content line-height-1 fw-medium text-secondary-light text-sm d-flex align-items-center gap-1 ps-4" htmlFor="Important"> 
                  ...
                  <div className="form-check form-radio d-flex align-items-center gap-2 mb-0">
                    ...
                    <label className="form-check-label min-width-max-content line-height-1 fw-medium text-secondary-light text-sm d-flex align-items-center gap-1 ps-4" htmlFor="Holiday"> 
              ...
              <div className="col-12 mb-20">
                ...
                <textarea className="form-control" id="desc" rows={4} cols={50} placeholder="Write some text" defaultValue={""} />
              </div>
              <div className="d-flex align-items-center justify-content-center gap-8 mt-24">
                <button type="reset" className="btn bg-danger-600 hover-bg-danger-800 border-danger-600 hover-border-danger-800 text-md px-24 py-12 radius-8"> 
                  Cancel
                </button>
                <button type="submit" className="btn bg-main-600 hover-bg-main-800 border-main-600 hover-border-main-800 text-md px-24 py-12 radius-8"> 
                  Save
                </button>
              </div>
            </div>
  ...
  {/* jvectormap world Js */}
  {/* main js */}
  {/* Mirrored from html.themeholy.com/edmate/event.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 02 Dec 2024 11:02:58 GMT */}
</div>
</>
    );
}
