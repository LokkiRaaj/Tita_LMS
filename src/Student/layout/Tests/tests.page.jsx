...
function StudentTestPage() {
    ...
    const selectedQuestions = location.state?.selectedQuestions || null;
            ...
            try {
                ...
                if (selectedQuestions) {
                    const filtered = data.courses.filter(
                        (course) => course.courseCategory === selectedQuestions
                    );
                                    ...
                                    <div className="card-body p-8">
                                        ...
                                        <div className="p-8">
                                            ...
                                            <div className="flex-between gap-4 flex-wrap mt-24">
                                                <Link to={`/student-viewtest?id=${course._id}`}
