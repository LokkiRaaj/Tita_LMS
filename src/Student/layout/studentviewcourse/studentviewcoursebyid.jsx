        ...
        <div className="dashboard-body">
            <div className="row gy-4">
                ...
                <div className="col-md-4">
                    ...
                    <div className="card-header" style={{ display: 'flex', justifyContent: 'center', paddingTop: '20px' }}>
                        <button className="btn btn-primary" style={{ fontSize: '20px', padding: '15px 30px' }}>
                            Enroll Now
                        </button>
                    </div>
