                ...
                <div className="flex-align gap-16">
                    ...
                    <form action="" className="w-350 d-sm-block d-none">
                        <div className="position-relative">
                            <button type="submit" className="input-icon text-xl d-flex text-gray-100 pointer-event-none"><i className="ph ph-magnifying-glass" /></button>
                                        ...
                                        <div className="py-8 px-24 bg-main-600">
                                            <div className="flex-between">
                                                ...
                                                <div className="flex-align gap-12">
                                                    ...
                                                    <button type="button" className="close-dropdown hover-scale-1 text-xl text-white"><i className="ph ph-x" /></button>
                                                </div>
                                            </div>
                                        </div>
