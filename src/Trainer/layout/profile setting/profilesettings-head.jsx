...
import TrainerprofileHeader from "./profile-header";

function TrainerprofileHead() {
    return (
        <div className="breadcrumb mb-24">
            <ul className="flex-align gap-4">
                ...
                <li><span className="text-main-600 fw-normal text-15">Profile Settings</span></li>
            </ul>
        </div>
    );
}

export default TrainerprofileHead;