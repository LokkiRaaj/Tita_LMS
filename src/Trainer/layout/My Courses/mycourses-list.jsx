                                ...
                                <div className="card-body p-8">
                                    ...
                                    <div className="p-8">
                                        ...
                                        <div className="flex-between gap-4 flex-wrap mt-24">
                                          ...
                                          <Link to={`/trainer-viewcourses?id=${course._id}`}>  <a href={course.buttonLink} className="btn btn-outline-main rounded-pill py-9">View Details</a> </Link>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
export default TrainerMycoursesList;
