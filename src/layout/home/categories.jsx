...
function Categories() {
    ...
    const handleCategoryClick = (category) => {
        navigate("/all-courses", { state: { selectedCategory: category.title } });
    };
                                    ...
                                    <div className="card-body p-8" onClick={() => handleCategoryClick(category)}>
                                        ...
                                        <div className="p-8">
                                            ...
                                            <div className="flex-between gap-4 flex-wrap mt-24">
                                                ...
                                                <a href={category.buttonLink} className="btn btn-outline-main rounded-pill py-9">View Categories</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
