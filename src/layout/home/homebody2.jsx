                            ...
                            <div className="card border border-gray-100">
                                <div className="card-body p-8">
                                    ...
                                    <div className="p-8">
                                        ...
                                        <h5 className="mb-0"><a href="" className="hover-text-main-600">Full Stack Web Development</a></h5>
                            ...
                            <div className="card border border-gray-100">
                                <div className="card-body p-8">
                                    ...
                                    <div className="p-8">
                                        ...
                                        <h5 className="mb-0"><a href="" className="hover-text-main-600">Design System</a></h5>
                                        <div className="flex-align gap-8 flex-wrap mt-16">
                            ...
                            <div className="card border border-gray-100">
                                <div className="card-body p-8">
                                    ...
                                    <div className="p-8">
                                        ...
                                        <h5 className="mb-0"><a href="" className="hover-text-main-600">React Native Courese</a></h5>
                                        <div className="flex-align gap-8 flex-wrap mt-16">
