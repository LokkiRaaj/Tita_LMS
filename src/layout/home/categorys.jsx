        ...
        <>
            ...
            <div className="card-body">
                <div className="mb-20 flex-between flex-wrap gap-8">
                    <h4 className="mb-0">Categorys</h4>
                </div>
                                    ...
                                    <div className="p-8">
                                        ...
                                        <div className="flex-align gap-8 mt-12 pt-12 border-top border-gray-100">
                                            <div className="flex-align gap-4">
                                                ...
                                                <span className="text-13 text-gray-600">{category.lessons}</span>
                                            </div>
                                            <div className="flex-align gap-4">
                                                <span className="text-sm text-main-600 d-flex"><i className="ph ph-clock" /></span>
                                                <span className="text-13 text-gray-600">{category.hours}</span>
                                            </div>
                                        </div>
                                        <div className="flex-between gap-4 flex-wrap mt-24">
                                            ...
                                            <a href={category.buttonLink} className="btn btn-outline-main rounded-pill py-9">View Categorys</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
